...
if __name__=="__main__":
    ...
    directory_path = os.path.join(out_dir, "visuals_2017")
    if not os.path.exists(directory_path):
        os.makedirs(directory_path)

    df = pd.read_csv('/home/will/uas-cotton-photogrammetry/output/yield_counted_marked_2017/2017_pixel_counts_and_hand_harvested_yield.csv')
    ...
    ax.set_title(label=r"\[\textbf{UAV Seeded Cotton Yield Measurement Model 2017}\]", fontdict={"fontsize":20}, pad=20)
    ...
    function_position_y = max(y)-(.80*max(y))
    ...
    plt.savefig(os.path.join(directory_path, "UAV_Seeded_Cotton_Yield_Measurement_Model_2017.png"))
